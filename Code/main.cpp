...
int main()
{
    ...
    // Then, we set the light's VAO (VBO stays the same. After all, they are the same for the light object (also a 3D cube))
    GLuint lightVAO;
...
//=======================================End Uniform====================================
        ...
        lightingShader.Use();
        //todo2: define several attributes of the objects, such as object color, light color and position, camera matrix and etc.
